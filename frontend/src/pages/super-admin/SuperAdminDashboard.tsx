    ...
    <div className="space-y-8 pb-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="inline-flex items-center gap-2 rounded-lg bg-red-600 px-4 py-2.5 text-sm font-medium text-white shadow-sm transition-colors hover:bg-red-700">
            Add Center
          </button>
        </div>
      </div>
                ...
                {filteredCenters.length === 0 ? (
                  ...
                  filteredCenters.map((center) => (
                    <tr key={center.id} className="group transition-colors hover:bg-gray-50">
                      ...
                      <td className="px-4 py-4">
                        <button className="text-xs font-medium text-red-600 opacity-0 transition-opacity group-hover:opacity-100 hover:text-red-800">
                          Manage →
                        </button>
                      </td>
                    </tr>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
          {[
            ...
            <button
              key={action.label}
              className="group flex flex-col items-start gap-3 rounded-xl border border-gray-200 bg-white p-5 text-left transition-all duration-200 hover:border-gray-300 hover:shadow-md"
            >
